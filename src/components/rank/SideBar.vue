<template>
  <div class="right-content">
    <div class="discription">
      ...
      <p class="text">枝网<span class="high">鼓励原创小作文和真情实感</span>，故设置<span class="high">"<span class="iconfont icon-all-like"></span>累计点赞数"</span></p>
      <p class="text">即:将<span class="high">所有重复小作文</span>的赞累计到<span class="high">最早</span>出现的相似<span class="high">[原创/原偷]</span>小作文上</p>
