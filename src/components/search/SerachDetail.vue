...
<template>
  <!-- search input -->
  <div
    class="bg-white rounded-xl flex space-x-2 mx-3 mt-4 text-lg p-3 py-2 search-input"
  >
    ...
    <div class="flex w-[calc(100%-3rem)] float-left">
      ...
      <span
        class="cursor-pointer iconfont icon-clean"
        v-if="cleanVisible"
        @click="text = ''"
      ></span>
    </div>
  ...
  <div class="space-y-4 mx-3 mt-4 search-result">
    <div
      class="bg-white rounded-lg shadow-sm p-2 pl-3"
      v-for="i in array"
      :key="i"
    >
